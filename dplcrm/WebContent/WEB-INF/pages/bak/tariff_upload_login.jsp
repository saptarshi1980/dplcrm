...
<div class="header">
    ...
    <table>
    <tr>
    <td><img src="${pageContext.request.contextPath}/resources/images/logo.gif"/></td>
         
    </table>
 </div>
 </div>
 </div>
<form id="form1" name="form1" method="POST" action="tariffLoginAuth.dpl" >
  <div align="center">
    <p>&nbsp;</p>
    <table width="621" height="256" border="2" bordercolor="#993300">
      <tr>
        <td height="248" bgcolor="#99CC99"><div align="center">
            <p><strong><span class="style10">              DPL TARIFF FILE UPLOAD LOGIN </span><br>
