...
<table border="1" bgcolor="cyan">
 <tr><td>   <font colour="RED">User id already exists for given Consumer No. If you have forgotten password, Kindly mail your details to admin@dpl.net.in for reset of password</font></td></tr>
...
<div class="container">
      ...
      <div  class="form">
    		<form id="contactform" action="consumerValidationAuth.dpl" method="POST"> 
