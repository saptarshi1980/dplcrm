...
public class UserLoginController {
	...
	@RequestMapping(value = "/UserLoginAuth.dpl", method = RequestMethod.POST)
	public ModelAndView loginAuth(@RequestParam("username") String username,@RequestParam("password") String password,HttpServletRequest request) {
    	...
    	if(user.getUserName().matches("U")){
    		...
    		ModelAndView model = new ModelAndView("unauthorised");
    		return model;
    		...
    		request.getSession().setAttribute("con_no", user.getConNo());
